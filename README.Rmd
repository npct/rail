...
The case study region of West Yorkshire is used to subset the dataset of `r nrow(od_england_wales)` OD pairs.
OD pairs converted to desire lines with more than `r param_min_flow_rail` people by any mode (black) and by rail (red) are shown below.
...
plot(desire_rail$geometry, col = "grey")
plot(desire_sample$geometry, col = "blue", add = TRUE, lwd = 2)
plot(region$geometry, add = TRUE)
